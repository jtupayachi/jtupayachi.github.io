...
\small
    \begin{itemize}[left=0pt] % Align items to the left
        ...
        \item \textbf{Design and usability testing of SmartSHOTS: A mobile app to reduce vaccine barriers for children 0–24 months} \\
        TH Wyatt, S Lowe, J Tupayachi, X Li, CA McNeely, X Wang, PD Taylor, ... \\
        \textit{Health Informatics Journal 32 (1), 14604582261419334} (2026) \\

        \item \textbf{Scalable decentralized prognostics for industrial systems under data heterogeneity} \\
        J Tupayachi, AN Khan, X Li \\
        \textit{Computers and Electrical Engineering 133, 111023} (2025) \\
...
\begin{itemize}[left=0pt] 
    ...
    % Submission ID: COMPELECENG-D-25-05978 - Third review round\\
    ...
    % Submission ID: HIJ-25-0257 - Acepted\\

    \item \textbf{CliniSense AI for Automated Clinical Skills Assessment with Real Time Feedback}  \\
    Submitted to \textit{npj digital medicine} \\
...
\vspace{0.3cm} \begin{twocolentry}{May 2025 – Present} \textbf{AI-Augmented Literature Retrieval and Exploration for Materials Research} \textbar
    % LLM-Powered Query Pipeline with BERT Tagging
 \end{twocolentry}

\begin{highlights}
    \item Developed an AI agent-driven literature survey pipeline for new materials discovery, automating search, retrieval, and synthesis of domain-specific publications to accelerate identification of candidate materials for nuclear and energy applications.
    \item Designed and implemented an explainable multi-tower gradient boosting model for extreme weather event analysis at the Oak Ridge Reservation, enabling interpretable predictions of high-impact meteorological conditions using heterogeneous sensor and atmospheric data.
    \item Built a vision transformer-based quality assurance engine for automated classification of wind speed and direction from observational data, improving reliability and throughput of atmospheric monitoring workflows.
    \item Engineered an automated end-to-end geospatial analysis interface driven by large language models, enabling non-expert users to query, process, and visualize spatial datasets through natural language interactions with minimal manual intervention.
\end{highlights}
...
\item \textbf{PLOS ONE}
\begin{itemize}
    \item \textit{Methods to derive composite indicators used for quality and safety measurement and monitoring in healthcare: a scoping review} (PONE-D-26-00569)
\end{itemize}
...
\begin{itemize}[left=0pt]
    ...
    \item{Automated Control: The Tragedy of the Commons in End-to-End AI-Driven Systems}

     
    \item{Literature Survey for New Materials Discovery Powered by AI Agents}
    \item{Explainable Multi-Tower Gradient Boosting for Extreme Weather Event Analysis at the Oak Ridge Reservation}
\item{Vision Transformer-Based Quality Assurance Engine for Wind Speed and Direction Classification}
\item{Automated End-to-End Geospatial Analysis: An AI-Driven Interface}
