...
\begin{document}
    ...
    \vspace{5 pt }
\small
    % Experienced professional in data analytics with a proven ability to design and implement data-driven solutions that drive business impact. Skilled in developing advanced machine learning systems, signal processing and integrating tools like retrieval-augmented generation and vector databases to enhance applications. Proficient in programming languages, data engineering, and data visualization, with a strong focus on collaboration and delivering scalable solutions by working effectively with interdisciplinary teams. These skill sets have been applied in developing health-support apps and decision support systems for transportation and logistics applications.
% Experienced professional with a strong foundation in machine learning, signal processing for Internet of Things applications, and the design of scalable, intelligent systems. Skilled in integrating technologies such as retrieval-augmented generation, vector databases, and large language models into real-world applications.
% Proven track record in developing health-support applications, IoT-based monitoring platforms, and decision support systems in transportation and logistics. Solutions have leveraged sensor data, real-time analytics, and optimization techniques to enhance operational performance and support high-impact decision-making.
...
% Subject: Health Informatics Journal - Decision on Manuscript HIJ-25-0257

% 19-Sep-2025

% Dear Dr. Wyatt,

% Manuscript HIJ-25-0257 entitled 'Design and Usability Testing of SmartSHOTS: A Mobile App to Reduce Vaccine Barriers for Children Aged 0-24 Months' which you submitted to Health Informatics Journal has been reviewed and the decision of Major Revision has been made.
