...
\begin{highlights}
    ...
    \item Implemented CI/CD deployment automation with Jenkins for automated builds, unit testing, and application deployment.
    \item Strengthened data quality (ad-hoc quality engine), profiling, and anomaly detection through validation frameworks and monitoring/alerting, and tuned Spark memory and resource allocation.
\end{highlights}
...
\begin{highlights}
    ...
    \item Developed a PyQt desktop application that automated invoice verification and programmatic special case handling, replacing manual billing handling.
\end{highlights}
...
\begin{highlights}
    ...
    \item Developed geospatial AI interfaces enabling natural-language interaction with spatial datasets and  analytics workflows.
...
\begin{highlights}
    ...
    \item Collaborated with Oak Ridge National Laboratory researchers to deliver an production platform, presented to DOE program sponsors.
