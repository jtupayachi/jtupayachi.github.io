...
\small
    ...
    \begin{itemize}[left=0pt] 
        ...
        \textit{https://papers.ssrn.com/sol3/Delivery.cfm?abstractid=5433957} (2025)
            ...
            \item \textbf{Context-Aware Visual Prompting: Automating Geospatial Web Dashboards with Large Language Models and Agent Self-Validation for Decision Support}\\
            Haowen Xu, Jose Tupayachi, Xiao-Ying Yu\\
            \textit{arXiv:submit/6869565 [cs.AI] 10 Oct 2025}
    ...
    \textit{arXiv:submit/6869563 [cs.LG] 10 Oct 2025}
...
\begin{itemize}[left=0pt]
    ...
    \item{Spatio-Temporal Methods for Air Particle and Quality:  Oak Ridge Reservation Study}
