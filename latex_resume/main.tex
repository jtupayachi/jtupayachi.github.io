...
\begin{itemize}[left=0pt] 
    ...
    % Keywords: Federated Learning, Fault Detection, RUL, Condition-Based Monitoring
...
\begin{itemize}[left=0pt]
    ...
    \item \textbf{Context Aware Visual Prompting:} A geospatial web dashboard development automation using large language models and self-validated embeddings to support decision making. 
