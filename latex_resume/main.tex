...
Jose Tupayachi is a Data and AI Engineer with 7+ years of application development experience across Python, SQL, Scala, and Java, specializing in scalable ETL, distributed computing, machine learning, and multimodal AI. He has 4+ years building distributed data platforms on public cloud, designing dimensional data models for cloud data warehouses, and delivering real-time streaming and NoSQL applications on UNIX/Linux. He designs end-to-end, agentic AI-driven data workflows, from ingestion, transformation, and orchestration to predictive modeling and decision support, integrating large language models, retrieval-augmented generation, and entity resolution to transform complex datasets into actionable insights. Working in Agile teams, he leverages AI-assisted coding tools to accelerate delivery, and applies rigorous data-quality, data-profiling, and anomaly-detection practices across production systems. His applied work spans materials science, AI-powered freight transportation digital twins, geospatial analytics, and cross-platform Android and iOS application development. He has published in \textit{Computers \& Electrical Engineering} and the \textit{Health Informatics Journal}, and has filed intellectual property disclosures at Oak Ridge National Laboratory.
...
\begin{highlights}
    \item Built Vision Transformer (ViT) and foundation vision models for a multi-pathway hybrid architecture powering \textit{Automated Quality Assurance of Meteorological Station Data for Atmospheric Dispersion Modeling (CAPARS)}, reaching macro $F_1 = 0.77$ across 394 stations.
    \item Developed agentic, traceable multimodal AI pipelines with LangChain and LangSmith, integrating large language models (LLMs) and retrieval-augmented generation (RAG), cutting expert literature-review and materials-discovery time by an estimated 60\%.
    \item Fine-tuned and deployed local open-weight models (Qwen, Llama) served via Ollama for autonomous literature mining and knowledge extraction, and accelerated delivery with AI-assisted coding tools (GitHub Copilot, Claude Code).
    ...
    \item Developed geospatial AI interfaces enabling natural-language querying, knowledge-graph reasoning, and interactive analytics over scientific spatial datasets.
...
\begin{highlights}
    \item Developed executive dashboards and KPI reporting systems serving 20+ business clients for strategic and operational decision-making.
...
\begin{highlights}
    \item Applied unsupervised learning (clustering) to segment 1M+ customers, improving payment-collection targeting and recovery rates.
...
\vspace{0.3cm}
\noindent\textbf{RECOIL} -- Cognitive Freight Transportation Digital Twin \hfill Jul 2024--Present

\noindent\textit{Role:} Lead AI/Data Engineer. Designed and built an end-to-end cognitive digital twin for large-scale intermodal freight transportation, integrating optimization, deep learning, large language models, and real-time streaming to minimize costs and $CO_2$ emissions.

\noindent\textit{Funding:} U.S. Department of Energy ARPA-E, Project \#DE-AR0001780.
...
\begin{highlights}
    ...
    \item Investigated BERT and sentence transformers for domain literature QA with accurate and reproducible responses.
    \item Collaborated with Oak Ridge National Laboratory researchers to deliver an industry-ready platform, presented to DOE program sponsors.
...
\noindent\textit{Role:} Full-Stack Developer. Built a cross-platform mobile application to improve childhood vaccination tracking and access for families across Tennessee.

\noindent\textit{Funding:} Tennessee Department of Health.

\begin{highlights}
    \item Developed a scalable Laravel backend and cross-platform Dart/Flutter frontend with real-time data updates, notifications, and alerts, shipped to the App Store and Google Play.
    ...
    \item \url{https://play.google.com/store/apps/details?id=com.ilab.smartshots} \quad \url{https://apps.apple.com/us/app/smartshots-tn/id6526502640}
\end{highlights}

\vspace{0.3cm}
\noindent\textbf{Active Caregiver's Toolkit (ACTAPP)} -- Mobile App for Physical Activity \hfill Jul 2024--Present

\noindent\textit{Role:} Mobile Developer. Developed a mobile health application targeting cardiovascular disease risk reduction through physical activity interventions for rural Appalachian caregivers.

\noindent\textit{Funding:} Hillman Emergent Innovation (HEI).

\begin{highlights}
    \item Implemented Dart 3.0, Material Design, and state management using GetX for a smooth cross-platform user experience.
    \item Integrated a ChatBot for FAQ answering and page/interaction tracking metrics for data analysis.
    \item \url{https://testflight.apple.com/join/PehxA8aW} \quad \url{https://play.google.com/store/apps/details?id=com.ilabutk.fe_rich}
\end{highlights}
