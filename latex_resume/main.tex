...
\begin{multicols}{2}
    ...
    \textbf{Optimization:} Networkx, Gurobi, cplex, AnyLogic Simulation \\
    \textbf{Tools:} Excel, Microsoft Office,  Linux
\end{multicols}
