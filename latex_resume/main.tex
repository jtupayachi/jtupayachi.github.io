...
- IISE 2025 Annual Conference - Logistics and Supply Chain (LSC) - [Analyzing the Impact of Hurricane Florence on Freight Transportation in North Carolina using Telematics data, Distributed Programmatic Demand Forecasting in Modular
...
\vspace{0.3cm}
- Winter Simulation Conference 2025 - Invited Paper - [Reliability Assessment of Convolutional Autoencoder-Based Wind Modeling for Autonomous Drone Training]\\
\vspace{0.3cm}
