...
Jose Tupayachi is a Data and AI Engineer specializing in scalable ETL/ELT, distributed computing, machine learning, and multimodal AI across Python, SQL, Scala, and Java. He builds distributed data platforms on public cloud, designs dimensional data models and lakehouse architectures for cloud data warehouses, and delivers real-time streaming and NoSQL applications on UNIX/Linux. He engineers end-to-end, agentic AI-driven data workflows, from ingestion, transformation, and orchestration to predictive modeling and decision support, integrating large language models, retrieval-augmented generation (RAG), Vision Transformers, and entity resolution to turn complex scientific and enterprise datasets into actionable insights. Working in Agile teams with AI-assisted coding tools, he applies rigorous data-quality, data-profiling, and anomaly-detection practices across production systems. His applied work spans materials science, AI-powered freight transportation digital twins, geospatial analytics, and cross-platform Android and iOS development. He has published in \textit{Computers \& Electrical Engineering} and the \textit{Health Informatics Journal}, and has filed intellectual property disclosures at Oak Ridge National Laboratory.
...
\begin{highlights}
    \item Built Vision Transformer (ViT) and foundation vision models within a multi-pathway hybrid architecture powering \textit{Automated Quality Assurance of Meteorological Station Data for Atmospheric Dispersion Modeling (CAPARS)}, classifying wind speed and direction across distributed station networks.
    \item Developed agentic, traceable multimodal AI pipelines with LangChain and LangSmith, integrating large language models (LLMs) and retrieval-augmented generation (RAG) to automate expert literature review and materials-discovery workflows.
...
\begin{highlights}
    ...
    \item Worked in Agile sprints and mentored junior researchers in model development and reproducible computational workflows.
\end{highlights}
...
\begin{highlights}
    ...
    \item Developed distributed data processing systems using Scala/PySpark on Apache Spark, Hadoop, Hive/HQL, and AWS (S3, EMR), migrating legacy Oracle warehouses to a partitioned cloud lakehouse and tuning Spark memory and resource allocation for faster job execution.
